...
function PortfolioCard({portfolio_img, portfolio_head, portfolio_text, Live_link}) {
    ...
    <>        
        <div  class="  relative flex w-80  flex-col rounded-xl bg-white/40 bg-clip-border text-gray-700 shadow-md hover:scale-105 transition duration-300 ease-in-out ">
            ...
            <div class="p-6">
                ...
                <p class="block h-[86px]  overflow-y-scroll  font-Poppins font-sans text-base text-[#000] font-light leading-relaxed  antialiased">
                    {portfolio_text} 
                </p>
            </div>
            <div class="p-6 pt-0">
                ...
                <a target="_blank" href={Live_link}>Live link </a>
                </button>
            </div>
        </div>
    </>
